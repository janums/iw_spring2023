...
define dso_local i8* @xstrdup(i8* %s) local_unnamed_addr #3 !dbg !174 {
entry:
  call void @llvm.dbg.value(metadata i8* %s, metadata !178, metadata !DIExpression()), !dbg !181
  %call = tail call i64 @strlen(i8* %s) #5, !dbg !182
  %add = add i64 %call, 1, !dbg !183
  call void @llvm.dbg.value(metadata i64 %add, metadata !179, metadata !DIExpression()), !dbg !181
  %call1 = tail call i8* @xmalloc(i64 %add) #5, !dbg !184
  call void @llvm.dbg.value(metadata i8* %call1, metadata !180, metadata !DIExpression()), !dbg !181
  %call2 = tail call i8* @memcpy(i8* %call1, i8* %s, i64 %add) #5, !dbg !185
  ret i8* %call2, !dbg !186
}
...
!1 = !DIFile(filename: "xstrdup.c", directory: "/u/ziyangx/old_or_raw_benchmarks/spec2017-workspace/benchspec/CPU/502.gcc_r/src")
!2 = !{}
!3 = !{!4, !5, !6}
...
!174 = distinct !DISubprogram(name: "xstrdup", scope: !1, file: !1, line: 31, type: !175, scopeLine: 32, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !177)
!175 = !DISubroutineType(types: !176)
!176 = !{!6, !18}
!177 = !{!178, !179, !180}
!178 = !DILocalVariable(name: "s", arg: 1, scope: !174, file: !1, line: 31, type: !18)
!179 = !DILocalVariable(name: "len", scope: !174, file: !1, line: 33, type: !96)
!180 = !DILocalVariable(name: "ret", scope: !174, file: !1, line: 34, type: !6)
!181 = !DILocation(line: 0, scope: !174)
!182 = !DILocation(line: 33, column: 25, scope: !174)
!183 = !DILocation(line: 33, column: 36, scope: !174)
!184 = !DILocation(line: 34, column: 24, scope: !174)
!185 = !DILocation(line: 35, column: 19, scope: !174)
!186 = !DILocation(line: 35, column: 3, scope: !174)
