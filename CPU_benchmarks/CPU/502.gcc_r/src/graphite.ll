; ModuleID = 'graphite.bc'
source_filename = "graphite.c"
...
@.str = private unnamed_addr constant [43 x i8] c"Graphite loop optimizations cannot be used\00", align 1
...
define dso_local void @graphite_transform_loops() local_unnamed_addr #3 !dbg !478 {
entry:
  tail call void (i8*, ...) @sorry(i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str, i64 0, i64 0)) #5, !dbg !481
  ret void, !dbg !482
}
...
!1 = !DIFile(filename: "graphite.c", directory: "/u/ziyangx/old_or_raw_benchmarks/spec2017-workspace/benchspec/CPU/502.gcc_r/src")
!2 = !{}
!3 = !{!4, !5, !6, !7, !10, !11}
...
!478 = distinct !DISubprogram(name: "graphite_transform_loops", scope: !1, file: !1, line: 287, type: !479, scopeLine: 288, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !2)
!479 = !DISubroutineType(types: !480)
!480 = !{null}
!481 = !DILocation(line: 289, column: 3, scope: !478)
!482 = !DILocation(line: 290, column: 1, scope: !478)
