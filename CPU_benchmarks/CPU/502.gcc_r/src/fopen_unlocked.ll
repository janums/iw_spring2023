...
define dso_local void @unlock_stream(%struct._IO_FILE* %fp) local_unnamed_addr #3 !dbg !174 {
entry:
  call void @llvm.dbg.value(metadata %struct._IO_FILE* %fp, metadata !178, metadata !DIExpression()), !dbg !179
  tail call fastcc void @unlock_1(%struct._IO_FILE* %fp) #6, !dbg !180
  ret void, !dbg !181
}

; Function Attrs: inlinehint nounwind uwtable
define internal fastcc void @unlock_1(%struct._IO_FILE* %fp) unnamed_addr #0 !dbg !182 {
entry:
  call void @llvm.dbg.value(metadata %struct._IO_FILE* %fp, metadata !187, metadata !DIExpression()), !dbg !188
  ret void, !dbg !189
}

; Function Attrs: nounwind uwtable
define dso_local void @unlock_std_streams() local_unnamed_addr #3 !dbg !190 {
entry:
  %0 = load %struct._IO_FILE*, %struct._IO_FILE** @stdin, align 8, !dbg !193
  tail call fastcc void @unlock_1(%struct._IO_FILE* %0) #6, !dbg !194
  %1 = load %struct._IO_FILE*, %struct._IO_FILE** @stdout, align 8, !dbg !195
  tail call fastcc void @unlock_1(%struct._IO_FILE* %1) #6, !dbg !196
  %2 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !dbg !197
  tail call fastcc void @unlock_1(%struct._IO_FILE* %2) #6, !dbg !198
  ret void, !dbg !199
}

; Function Attrs: nounwind uwtable
define dso_local %struct._IO_FILE* @fopen_unlocked(i8* %path, i8* %mode) local_unnamed_addr #3 !dbg !200 {
entry:
  call void @llvm.dbg.value(metadata i8* %path, metadata !204, metadata !DIExpression()), !dbg !207
  call void @llvm.dbg.value(metadata i8* %mode, metadata !205, metadata !DIExpression()), !dbg !207
  %call = tail call %struct._IO_FILE* @fopen(i8* %path, i8* %mode) #5, !dbg !208
  call void @llvm.dbg.value(metadata %struct._IO_FILE* %call, metadata !206, metadata !DIExpression()), !dbg !207
  tail call fastcc void @unlock_1(%struct._IO_FILE* %call) #6, !dbg !209
  ret %struct._IO_FILE* %call, !dbg !210
}

declare dso_local %struct._IO_FILE* @fopen(i8*, i8*) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local %struct._IO_FILE* @fdopen_unlocked(i32 %fildes, i8* %mode) local_unnamed_addr #3 !dbg !211 {
entry:
  call void @llvm.dbg.value(metadata i32 %fildes, metadata !215, metadata !DIExpression()), !dbg !218
  call void @llvm.dbg.value(metadata i8* %mode, metadata !216, metadata !DIExpression()), !dbg !218
  %call = tail call %struct._IO_FILE* @fdopen(i32 %fildes, i8* %mode) #5, !dbg !219
  call void @llvm.dbg.value(metadata %struct._IO_FILE* %call, metadata !217, metadata !DIExpression()), !dbg !218
  tail call fastcc void @unlock_1(%struct._IO_FILE* %call) #6, !dbg !220
  ret %struct._IO_FILE* %call, !dbg !221
}

declare dso_local %struct._IO_FILE* @fdopen(i32, i8*) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local %struct._IO_FILE* @freopen_unlocked(i8* %path, i8* %mode, %struct._IO_FILE* %stream) local_unnamed_addr #3 !dbg !222 {
entry:
  call void @llvm.dbg.value(metadata i8* %path, metadata !226, metadata !DIExpression()), !dbg !230
  call void @llvm.dbg.value(metadata i8* %mode, metadata !227, metadata !DIExpression()), !dbg !230
  call void @llvm.dbg.value(metadata %struct._IO_FILE* %stream, metadata !228, metadata !DIExpression()), !dbg !230
  %call = tail call %struct._IO_FILE* @freopen(i8* %path, i8* %mode, %struct._IO_FILE* %stream) #5, !dbg !231
  call void @llvm.dbg.value(metadata %struct._IO_FILE* %call, metadata !229, metadata !DIExpression()), !dbg !230
  tail call fastcc void @unlock_1(%struct._IO_FILE* %call) #6, !dbg !232
  ret %struct._IO_FILE* %call, !dbg !233
}

declare dso_local %struct._IO_FILE* @freopen(i8*, i8*, %struct._IO_FILE*) local_unnamed_addr #1
...
!1 = !DIFile(filename: "fopen_unlocked.c", directory: "/u/ziyangx/old_or_raw_benchmarks/spec2017-workspace/benchspec/CPU/502.gcc_r/src")
!2 = !{}
!3 = !{!4, !5}
...
!174 = distinct !DISubprogram(name: "unlock_stream", scope: !1, file: !1, line: 91, type: !175, scopeLine: 92, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !177)
!175 = !DISubroutineType(types: !176)
!176 = !{null, !44}
!177 = !{!178}
!178 = !DILocalVariable(name: "fp", arg: 1, scope: !174, file: !1, line: 91, type: !44)
!179 = !DILocation(line: 0, scope: !174)
!180 = !DILocation(line: 93, column: 3, scope: !174)
!181 = !DILocation(line: 94, column: 1, scope: !174)
!182 = distinct !DISubprogram(name: "unlock_1", scope: !1, file: !1, line: 82, type: !183, scopeLine: 83, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !186)
!183 = !DISubroutineType(types: !184)
!184 = !{null, !185}
!185 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !44)
!186 = !{!187}
!187 = !DILocalVariable(name: "fp", arg: 1, scope: !182, file: !1, line: 82, type: !185)
!188 = !DILocation(line: 0, scope: !182)
!189 = !DILocation(line: 88, column: 1, scope: !182)
!190 = distinct !DISubprogram(name: "unlock_std_streams", scope: !1, file: !1, line: 97, type: !191, scopeLine: 98, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !2)
!191 = !DISubroutineType(types: !192)
!192 = !{null}
!193 = !DILocation(line: 99, column: 13, scope: !190)
!194 = !DILocation(line: 99, column: 3, scope: !190)
!195 = !DILocation(line: 100, column: 13, scope: !190)
!196 = !DILocation(line: 100, column: 3, scope: !190)
!197 = !DILocation(line: 101, column: 13, scope: !190)
!198 = !DILocation(line: 101, column: 3, scope: !190)
!199 = !DILocation(line: 102, column: 1, scope: !190)
!200 = distinct !DISubprogram(name: "fopen_unlocked", scope: !1, file: !1, line: 105, type: !201, scopeLine: 106, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !203)
!201 = !DISubroutineType(types: !202)
!202 = !{!44, !16, !16}
!203 = !{!204, !205, !206}
!204 = !DILocalVariable(name: "path", arg: 1, scope: !200, file: !1, line: 105, type: !16)
!205 = !DILocalVariable(name: "mode", arg: 2, scope: !200, file: !1, line: 105, type: !16)
!206 = !DILocalVariable(name: "fp", scope: !200, file: !1, line: 107, type: !185)
!207 = !DILocation(line: 0, scope: !200)
!208 = !DILocation(line: 107, column: 20, scope: !200)
!209 = !DILocation(line: 108, column: 3, scope: !200)
!210 = !DILocation(line: 109, column: 3, scope: !200)
!211 = distinct !DISubprogram(name: "fdopen_unlocked", scope: !1, file: !1, line: 113, type: !212, scopeLine: 114, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !214)
!212 = !DISubroutineType(types: !213)
!213 = !{!44, !14, !16}
!214 = !{!215, !216, !217}
!215 = !DILocalVariable(name: "fildes", arg: 1, scope: !211, file: !1, line: 113, type: !14)
!216 = !DILocalVariable(name: "mode", arg: 2, scope: !211, file: !1, line: 113, type: !16)
!217 = !DILocalVariable(name: "fp", scope: !211, file: !1, line: 115, type: !185)
!218 = !DILocation(line: 0, scope: !211)
!219 = !DILocation(line: 115, column: 20, scope: !211)
!220 = !DILocation(line: 116, column: 3, scope: !211)
!221 = !DILocation(line: 117, column: 3, scope: !211)
!222 = distinct !DISubprogram(name: "freopen_unlocked", scope: !1, file: !1, line: 121, type: !223, scopeLine: 122, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !225)
!223 = !DISubroutineType(types: !224)
!224 = !{!44, !16, !16, !44}
!225 = !{!226, !227, !228, !229}
!226 = !DILocalVariable(name: "path", arg: 1, scope: !222, file: !1, line: 121, type: !16)
!227 = !DILocalVariable(name: "mode", arg: 2, scope: !222, file: !1, line: 121, type: !16)
!228 = !DILocalVariable(name: "stream", arg: 3, scope: !222, file: !1, line: 121, type: !44)
!229 = !DILocalVariable(name: "fp", scope: !222, file: !1, line: 123, type: !185)
!230 = !DILocation(line: 0, scope: !222)
!231 = !DILocation(line: 123, column: 20, scope: !222)
!232 = !DILocation(line: 124, column: 3, scope: !222)
!233 = !DILocation(line: 125, column: 3, scope: !222)
