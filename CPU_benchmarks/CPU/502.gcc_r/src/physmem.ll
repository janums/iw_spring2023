...
define dso_local double @physmem_total() local_unnamed_addr #3 !dbg !174 {
entry:
  %call = tail call i64 @sysconf(i32 85) #5, !dbg !182
  %conv = sitofp i64 %call to double, !dbg !182
  call void @llvm.dbg.value(metadata double %conv, metadata !179, metadata !DIExpression()), !dbg !183
  %call1 = tail call i64 @sysconf(i32 30) #5, !dbg !184
  %conv2 = sitofp i64 %call1 to double, !dbg !184
  call void @llvm.dbg.value(metadata double %conv2, metadata !181, metadata !DIExpression()), !dbg !183
  %0 = or i64 %call, %call1, !dbg !185
  %1 = icmp sgt i64 %0, -1, !dbg !185
  %mul = fmul double %conv, %conv2, !dbg !185
  %spec.select = select i1 %1, double %mul, double 0.000000e+00
  ret double %spec.select, !dbg !187
}

declare dso_local i64 @sysconf(i32) local_unnamed_addr #1

; Function Attrs: nounwind uwtable
define dso_local double @physmem_available() local_unnamed_addr #3 !dbg !188 {
entry:
  %call = tail call i64 @sysconf(i32 86) #5, !dbg !193
  %conv = sitofp i64 %call to double, !dbg !193
  call void @llvm.dbg.value(metadata double %conv, metadata !190, metadata !DIExpression()), !dbg !194
  %call1 = tail call i64 @sysconf(i32 30) #5, !dbg !195
  %conv2 = sitofp i64 %call1 to double, !dbg !195
  call void @llvm.dbg.value(metadata double %conv2, metadata !192, metadata !DIExpression()), !dbg !194
  %0 = or i64 %call, %call1, !dbg !196
  %1 = icmp sgt i64 %0, -1, !dbg !196
  %mul = fmul double %conv, %conv2, !dbg !196
  br i1 %1, label %return, label %cleanup.cont

cleanup.cont:                                     ; preds = %entry
  %call7 = tail call double @physmem_total() #6, !dbg !198
  %div = fmul double %call7, 2.500000e-01, !dbg !199
  br label %return, !dbg !200

return:                                           ; preds = %entry, %cleanup.cont
  %retval.1 = phi double [ %mul, %entry ], [ %div, %cleanup.cont ], !dbg !201
  ret double %retval.1, !dbg !202
}
...
!1 = !DIFile(filename: "physmem.c", directory: "/u/ziyangx/old_or_raw_benchmarks/spec2017-workspace/benchspec/CPU/502.gcc_r/src")
!2 = !{}
!3 = !{!4, !5}
...
!174 = distinct !DISubprogram(name: "physmem_total", scope: !1, file: !1, line: 83, type: !175, scopeLine: 84, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !178)
!175 = !DISubroutineType(types: !176)
!176 = !{!177}
!177 = !DIBasicType(name: "double", size: 64, encoding: DW_ATE_float)
!178 = !{!179, !181}
!179 = !DILocalVariable(name: "pages", scope: !180, file: !1, line: 87, type: !177)
!180 = distinct !DILexicalBlock(scope: !174, file: !1, line: 86, column: 3)
!181 = !DILocalVariable(name: "pagesize", scope: !180, file: !1, line: 88, type: !177)
!182 = !DILocation(line: 87, column: 20, scope: !180)
!183 = !DILocation(line: 0, scope: !180)
!184 = !DILocation(line: 88, column: 23, scope: !180)
!185 = !DILocation(line: 89, column: 20, scope: !186)
!186 = distinct !DILexicalBlock(scope: !180, file: !1, line: 89, column: 9)
!187 = !DILocation(line: 183, column: 1, scope: !174)
!188 = distinct !DISubprogram(name: "physmem_available", scope: !1, file: !1, line: 187, type: !175, scopeLine: 188, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !189)
!189 = !{!190, !192}
!190 = !DILocalVariable(name: "pages", scope: !191, file: !1, line: 191, type: !177)
!191 = distinct !DILexicalBlock(scope: !188, file: !1, line: 190, column: 3)
!192 = !DILocalVariable(name: "pagesize", scope: !191, file: !1, line: 192, type: !177)
!193 = !DILocation(line: 191, column: 20, scope: !191)
!194 = !DILocation(line: 0, scope: !191)
!195 = !DILocation(line: 192, column: 23, scope: !191)
!196 = !DILocation(line: 193, column: 20, scope: !197)
!197 = distinct !DILexicalBlock(scope: !191, file: !1, line: 193, column: 9)
!198 = !DILocation(line: 283, column: 10, scope: !188)
!199 = !DILocation(line: 283, column: 27, scope: !188)
!200 = !DILocation(line: 283, column: 3, scope: !188)
!201 = !DILocation(line: 0, scope: !188)
!202 = !DILocation(line: 284, column: 1, scope: !188)
