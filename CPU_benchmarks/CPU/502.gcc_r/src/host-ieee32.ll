; ModuleID = 'host-ieee32.bc'
source_filename = "host-ieee32.c"
...
define dso_local void @__host_to_ieee_32(i32 %in, %struct.decimal32* %out) local_unnamed_addr #0 !dbg !10 {
entry:
  %in.addr = alloca i32, align 4
  call void @llvm.dbg.value(metadata i32 %in, metadata !31, metadata !DIExpression()), !dbg !33
  store i32 %in, i32* %in.addr, align 4
  call void @llvm.dbg.value(metadata %struct.decimal32* %out, metadata !32, metadata !DIExpression()), !dbg !33
  %0 = getelementptr inbounds %struct.decimal32, %struct.decimal32* %out, i64 0, i32 0, i64 0, !dbg !34
  %1 = bitcast i32* %in.addr to i8*, !dbg !35
  %call = call i8* @memcpy(i8* %0, i8* nonnull %1, i64 4) #3, !dbg !36
  ret void, !dbg !37
}
...
; Function Attrs: nounwind uwtable
define dso_local void @__ieee_to_host_32(i32 %in.coerce, i32* %out) local_unnamed_addr #0 !dbg !38 {
entry:
  %in = alloca i32, align 4
  store i32 %in.coerce, i32* %in, align 4
  call void @llvm.dbg.value(metadata i32* %out, metadata !44, metadata !DIExpression()), !dbg !45
  %0 = bitcast i32* %out to i8*, !dbg !46
  %1 = bitcast i32* %in to i8*, !dbg !47
  %call = call i8* @memcpy(i8* %0, i8* nonnull %1, i64 4) #3, !dbg !48
  ret void, !dbg !49
}
...
!1 = !DIFile(filename: "host-ieee32.c", directory: "/u/ziyangx/old_or_raw_benchmarks/spec2017-workspace/benchspec/CPU/502.gcc_r/src")
!2 = !{}
!3 = !{!4}
...
!10 = distinct !DISubprogram(name: "__host_to_ieee_32", scope: !1, file: !1, line: 43, type: !11, scopeLine: 44, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !30)
!11 = !DISubroutineType(types: !12)
!12 = !{null, !13, !16}
!13 = !DIDerivedType(tag: DW_TAG_typedef, name: "UINT32", file: !14, line: 25, baseType: !15)
...
!17 = !DIDerivedType(tag: DW_TAG_typedef, name: "decimal32", file: !18, line: 64, baseType: !19)
!18 = !DIFile(filename: "./decimal32.h", directory: "/u/ziyangx/old_or_raw_benchmarks/spec2017-workspace/benchspec/CPU/502.gcc_r/src")
!19 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !18, line: 62, size: 32, elements: !20)
!20 = !{!21}
!21 = !DIDerivedType(tag: DW_TAG_member, name: "bytes", scope: !19, file: !18, line: 63, baseType: !22, size: 32)
!22 = !DICompositeType(tag: DW_TAG_array_type, baseType: !23, size: 32, elements: !28)
...
!38 = distinct !DISubprogram(name: "__ieee_to_host_32", scope: !1, file: !1, line: 49, type: !39, scopeLine: 50, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !42)
