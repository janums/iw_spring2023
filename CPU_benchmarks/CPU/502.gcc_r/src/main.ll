...
define dso_local i32 @main(i32 %argc, i8** %argv) local_unnamed_addr #3 !dbg !478 {
entry:
  call void @llvm.dbg.value(metadata i32 %argc, metadata !482, metadata !DIExpression()), !dbg !484
  call void @llvm.dbg.value(metadata i8** %argv, metadata !483, metadata !DIExpression()), !dbg !484
  %call = tail call i32 @toplev_main(i32 %argc, i8** %argv) #5, !dbg !485
  ret i32 %call, !dbg !486
}

declare dso_local i32 @toplev_main(i32, i8**) local_unnamed_addr #1
...
!1 = !DIFile(filename: "main.c", directory: "/u/ziyangx/old_or_raw_benchmarks/spec2017-workspace/benchspec/CPU/502.gcc_r/src")
!2 = !{}
!3 = !{!4, !5, !6, !7, !10, !11}
...
!478 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 33, type: !479, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !481)
!479 = !DISubroutineType(types: !480)
!480 = !{!6, !6, !7}
!481 = !{!482, !483}
!482 = !DILocalVariable(name: "argc", arg: 1, scope: !478, file: !1, line: 33, type: !6)
!483 = !DILocalVariable(name: "argv", arg: 2, scope: !478, file: !1, line: 33, type: !7)
!484 = !DILocation(line: 0, scope: !478)
!485 = !DILocation(line: 35, column: 10, scope: !478)
!486 = !DILocation(line: 35, column: 3, scope: !478)
